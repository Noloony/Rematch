...
local expansionRanges = {
    ...
    [10] = {4422,4911}, -- The War Within
    [11] = {4912,9999}, -- Midnight (next expansion, get max speciesID for TWW and change 9999 to that)
}
 ...
 local expansionOutliers = {
    ...
    [5026] = 2, -- Family Battler
    [220] = 3, -- Withers
    [255] = 3, -- Celestial Dragon
    [5027] = 3, -- Family Battler
    [231] = 4, -- Jade Tiger
