...
rematch.events:Register(rematch.petFilterMenu,"PLAYER_LOGIN",function(self)
	...
	for i=11,0,-1 do
		tinsert(expansionMenu,{text=rematch.utils:GetFormattedExpansionName(i), check=true, group="Expansion", key=i, icon=pfm.GetIcon, isChecked=pfm.GetChecked, func=pfm.ToggleChecked, multiCheck=11, multiCheckStart=0})
	end
